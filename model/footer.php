...
<footer style="background: #222; color: #fff; padding: 60px 0; font-family: Arial, sans-serif;">
    <div class="container">
        <div class="row">
            ...
            <!-- Dịch vụ khách hàng -->
            <div class="col-md-3 col-sm-6 mb-4">
                <h4 style="color: #fbdd12; margin-bottom: 20px;">Dịch vụ khách hàng</h4>
                <ul style="list-style: none; padding: 0; color: #ccc;">
                    <li><a href="#" style="color: #ccc; text-decoration: none;">Cơ chế đặt hàng trực tuyến</a></li>
                    <li><a href="#" style="color: #ccc; text-decoration: none;">Chính Sách Khách Hàng</a></li>
                    <li><a href="#" style="color: #ccc; text-decoration: none;">Vận chuyển và thanh toán</a></li>
                    <li><a href="#" style="color: #ccc; text-decoration: none;">Bảo hành và đổi trả</a></li>
                    <li><a href="#" style="color: #ccc; text-decoration: none;">Khuyến mãi</a></li>
            ...
            <!-- Chi nhánh -->
            <div class="col-md-3 col-sm-6 mb-4">
                <h4 style="color: #fbdd12; margin-bottom: 20px;">Chi nhánh</h4>
                <ul style="list-style: none; padding: 0; color: #ccc;">
                    <li>Đà Nẵng:</li>
