...
<body>
    ...
    <div class="container-fluid">
        <div id="bg">
            <?php
            // Lọc giá dùng chung (cho background hoặc sản phẩm nếu muốn)
            $priceFilter = "";
            ...
            // Background
            $sql = "SELECT * FROM products WHERE status = 1 " . $priceFilter;
            $bg = $conn->query($sql);
            while ($row = $bg->fetch(PDO::FETCH_ASSOC)) {
            ?>
                    ...
                    <div class="product-main">
                        ...
                        <div class="content-product-main">
                            <div class="row">
                                ...
                                <?php
                                // Lấy sản phẩm mới + áp dụng lọc giá
                                $sql = "SELECT id, image, name, price FROM products 
                                        WHERE category_id = 3 AND status = 0 " . $priceFilter;
